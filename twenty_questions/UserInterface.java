...
/**
 * Interface describing abstract user interaction operations. This interface is
 * implemented by the graphical and text UIs for the game. Your QuestionTree
 * interacts with the UI through this interface.
 * 
 * @author Marty Stepp
 * @version 2010/02/20
 */
public interface UserInterface {
	/**
	 * Waits for the user to input a yes/no answer (by typing, clicking, etc.), and
	 * returns that answer as a boolean value.
	 * 
	...
	/**
	 * Waits for the user to input a text value, and returns that answer as a
	 * String.
	 * 
	 * @return the answer typed by the user as a String (empty string if no answer
	 *         typed)
	 */
	String nextLine();
	...
	/**
	 * Displays the given output message to the user. If the UI is a text UI, also
